...
pg = plotting.PlotGrid(subplots = [sp],
        ...
        width = 3.5,
        auto_height = False)
pg.savefig('../images/lizard-pigment-histogram-stabilizing.png')
...
pg = plotting.PlotGrid(subplots = [sp],
        ...
        width = 3.5,
        auto_height = False)
pg.savefig('../images/lizard-pigment-histogram-disruptive.png')
...
pg = plotting.PlotGrid(subplots = [sp],
        ...
        width = 3.5,
        auto_height = False)
pg.savefig('../images/lizard-pigment-histogram-directional.png')
