...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \nbox{Deer browse shrubs and small trees---stripped all vegetation and
            population crashed}
...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \nbox{If we want to test if mussels will increase shell thickness in
            ...
            from broken mussel shells, and (2) mussels not downstream from
...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \centerline{
        \includegraphics[height=0.7\textheight]{yellowstone-web.png}
        }
