...
{
\usebackgroundtemplate{\includegraphics[page=1,width=\paperwidth]{./celese-slides.pdf}}
\begin{frame}[plain]
\end{frame}
}
{
\usebackgroundtemplate{\includegraphics[page=2,width=\paperwidth]{./celese-slides.pdf}}
\begin{frame}[plain]
\end{frame}
}
{
\usebackgroundtemplate{\includegraphics[page=3,width=\paperwidth]{./celese-slides.pdf}}
\begin{frame}[plain]
\end{frame}
}
{
\usebackgroundtemplate{\includegraphics[page=4,width=\paperwidth]{./celese-slides.pdf}}
\begin{frame}[plain]
\end{frame}
}
