...
\begin{frame}
    ...
    \begin{description}
        \item[Gene] \uncover<2->{A factor that influences the phenotype for a
                particular trait, and is passed on to offspring.}
        \item[Allele] \uncover<2->{A particular form of a gene.}
    \end{description}
\end{frame}
        ...
        \item During gamete formation in a parent, pairs of alleles segregate
            ...
            \begin{itemize}
                ...
                \item What are the \highlight{gamete} genotypes produced
                    ...
                    \begin{itemize}
                        \item $PP$ \hspace{9mm}\hmask{\highlight{$\frac{1}{2}P:\frac{1}{2}P$ (or simply $P$)}}
                            \vspace{3mm}
                        \item $Pp$ \hspace{10mm}\hmask{\highlight{$\frac{1}{2}P:\frac{1}{2}p$}}
                            \vspace{3mm}
                        \item $A_{1}A_{2}$ \hspace{6mm}\hmask{\highlight{$\frac{1}{2}A_1:\frac{1}{2}A_2$}}
                            \vspace{3mm}
                        \item $X^{R}X^{r}$ \hspace{5mm}\hmask{\highlight{$\frac{1}{2}X^{R} : \frac{1}{2}X^{r}$}}
                    \end{itemize}
            \end{itemize}
    \end{enumerate}
