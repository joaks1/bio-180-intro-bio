...
\begin{frame}[t,plain]
    \begin{adjustwidth}{-2em}{-1.5em}
        % \cmask{Answer: 5}
    \end{adjustwidth}
    \note[item]{These all (1) are monophyletic, (2) speciated rapidly, and (3)
        diversified ecologically. Hawaiian silverswords closest relative is a
        tarweed from California; colonized islands about 5mya.}
\end{frame}
}
