...
\begin{frame}
    \begin{clickerquestion}
        \item Why is it correct to claim that data from relative dating,
            absolute dating, structural homology, genetics and biology of
            living species, and phylogenies represent independent tests of
            ...
            \begin{enumerate}
                \item Competitors wiped out
                    ...
                    \nbox{Resources that were formerly being used by competing
                        species are now available to exploit}
...
\begin{frame}
    \begin{clickerquestion}
        ...
        \begin{clickeroptions}
            ...
            \item Variables plotted on the x-axis (predictor or independent
                variables) cause the observed changes in the response variable. 
...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \textbf{Killing mechanisms:}
            ...
            \nbox{Wildfires, global cooling due to soot/ash/dust, tsunamis or
