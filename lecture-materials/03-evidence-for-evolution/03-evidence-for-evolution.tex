...
\begin{frame}
    ...
    \end{quote}
\end{frame}
\note{Highlight these passages in your notes.}
\note{Focus on diff of theory in everyday English v biology/science}
\note{Tennessee 1926 was the Scopes trial = illegal to teach evolution}
\note{Louisiana 1987 was equal time legislation struck down by the US Supreme
    Court; Edwards v Aguillard}
\note{Washington 2002 is correct}
\note{Pennsylvania 2005  Dover trial}
\note{Additional note on nature of a theory: everyday English v use in science}
\note{Germ theory of disease, cell theory, theory of gravitation, atomic
...
\begin{frame}
    ...
    the previous slide?
    \wbox{There was persuasive evidence to support these theories, even though
...
\end{frame}
\note{human perception as a model; our brain processes data to create a (very)
...
\begin{frame}
    ...
    \note{Special creation aka scientific creationism aka intelligent design}
    ...
    \uncover<2->{Is it a valid scientific hypothesis or theory?}
        \wbox{No---it lacks a process component}
...
\begin{frame}[t]
    ...
    \begin{enumerate}
        ...
        % Draw this
    \end{enumerate}
    % Many other island groups with similar patterns. E.g., Anolis lizards
    % in Caribbean, Fruit flies and silverswords in Hawaii
...
\begin{frame}
    ...
    \note{What predictions does the theory of special creation make?  Problem:
...
\begin{frame}
    ...
    \begin{uncoverenv}<2->
    \includegraphics[height=2.7cm]{../images/canis-lupus.jpg}\hspace{0.1mm}
    \includegraphics[height=2.7cm]{../images/canis-simensis.jpg}\hspace{0.1mm}
    \includegraphics[height=2.7cm]{../images/thylacinus.jpg}
    \end{uncoverenv}

    \uncover<3->{
    Why are timber wolves and Ethiopian wolves extremely similar at the
    genetic, developmental, and structural levels, while thylacines are only
    extremely similar at the structural level?
    }
...
\begin{frame}
    ...
    \hidebox{Find examples of each pattern above. Are these patterns more
...
\begin{frame}
    ...
    \end{itemize}
    \note{this is the distinction between science, pseudoscience, and religion}
    \note{There is no conflict between science and religion---except for
        literal interpretation of the creation story of the Book of Genesis}
    \note{US courts have always said No}
