                ...
                \begin{itemize}
                    \item What does random mean?
                        ...
                        \nbox{During replication mistakes are random with
                            respect to location (which base gets changed), and
                            random with respect to type (which base it changes
                            to)}
                \end{itemize}
                ...
                \begin{itemize}
                    \item Do these breaks affect the genotype?
                        ...
                        \nbox{It depends on where the break occurs. If the
                            ...
                            new, broken (not expressed) allele}
...
\begin{frame}
    \begin{clickerquestion}
        \item  How does mutation create \emph{heritable} variation?
        \begin{clickeroptions}
