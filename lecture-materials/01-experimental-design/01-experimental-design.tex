    ...
    \frametitle{How does this class work?}
        ...
        \begin{itemize}
            \item<1-> Reading quizzes
                \wbox{Open after the previous lecture and close 8AM the day of
                    lecture; Almost all questions are at Bloom levels 1--2
                    (very important to build from in lecture!); FIRST ONE?
                    Opens Tuesday after class! Drop lowest 2}
            \item<2-> Clickers
                \wbox{When do we use them? Everyday! Graded for correctness;
                    drop lowest 4. When do we start? This Wednesday, register
                    by 8AM.}
            \item<3-> Practice exams
                \wbox{What day of week? Friday! Where? Online, no class.
                    Peer-graded}
            \item<4-> Exams
                \wbox{What day of week? Friday! Where? Here. How many? 4. When
                    is the first? Two weeks from this Friday.}
            \item<5-> Seating chart
        \end{itemize}
\end{frame}
\end{noheadline}
...
\begin{frame}
    ...
    \begin{clickerquestion}
        \item What best describes the BIO 180 grading system?
            ...
            \item Competitive
            \item \clickeranswer{Non-competitive}
        \end{clickeroptions}
    \end{clickerquestion}
\end{frame}
\end{noheadline}
