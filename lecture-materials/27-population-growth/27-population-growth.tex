...
\begin{frame}
    \begin{clickerquestion}
        ...
        \end{clickeroptions}
    \end{clickerquestion}
    \note[item]{This phenomenon is called sex role reversal; reversal of
...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \end{table}
    \end{adjustwidth}
    \note[item]{How did birds introduced in WI learn the WI--FL migration
        route? Normally they learn from Mom and Dad.}
\end{frame}
...
\begin{frame}[t]
    ...
    \end{adjustwidth}
    \note[item]{Draw plot of positive and negative exponential growth}
\end{frame}
...
\begin{frame}
    ...
    \item If this \popgrowthrate{} (0.0459) were sustained, how many MORE years
        (from 2014) will it take to reach the goal of a world population of
        1000 (HINT: $\popsize{0} = 600$?)
...
\begin{frame}[t]
    \begin{adjustwidth}{-2em}{-1.5em}
        ...
        \nbox{Disease rate---higher transmission rates at higher densities}

        \vspace{2.7cm}
        How to test these hypotheses?

        \nbox{Experimentally remove the hypothesized constraint from some
            populations, and not in other populations. If it was constraining
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \includegraphics[width=\columnwidth]{daphnia-pop-growth.png}
...
 
    ...
    \nbox{\tiny (1)---If so, population would go to zero (we don't see that).
          (2)---Correct.
